...
export const guardian: Audit[] = [
  ...
  { client: "GMX Crosschain — 1", tags: ["crosschain", "derivatives", "perps"], duration: "3 weeks" },
  ...
  { client: "GMX Crosschain — 2", tags: ["crosschain", "derivatives", "perps"], duration: "1.5 weeks" },
  ...
  { client: "GMX Crosschain — 3", tags: ["crosschain", "derivatives", "perps"], duration: "1 week" },
  { client: "M0 Uniswap Hooks", tags: ["amm"], duration: "0.5 week" },
  { client: "GMX Crosschain — 4", tags: ["crosschain", "derivatives", "perps"], duration: "1 week" },
  ...
  { client: "GMX V2 · V2.2C · V2.3", tags: ["derivatives", "perps"], duration: "7 weeks" },
  ...
  { client: "LayerZero ██████", tags: [], duration: "1 week" },
  { client: "Perpcity", tags: [], duration: "2 weeks" },
];
...
export const macro: Audit[] = [
  ...
  { client: "Kwenta", tags: ["account-abstraction", "perps"], position: "Associate", duration: "2 weeks", report: "/reports/Kwenta.pdf" },
...
export const contests: Contest[] = [
  { place: "1st", client: "Raft Finance", findings: "1H · 1M · 3L · 1G", href: "https://github.com/raft-fi/contracts/issues?q=is%3Aissue%20is%3Aclosed%20author%3A0xcuriousapple" },
  { place: "1st", client: "VMEX Finance", findings: "1H · 1L", href: "https://github.com/hats-finance/VMEX-0x050183b53cf62bcd6c2a932632f8156953fd146f/issues/24" },
  { place: "1st", client: "Reserve Protocol", findings: "2M", href: "https://cantina.xyz/competitions/9dfca0bc-a7bf-482e-a3df-4eb861f55c4f/leaderboard" },
  { place: "3rd", client: "Socket Messaging Bridge", findings: "1H · 1M · 1L", href: "https://sockettech.notion.site/WarRoom-Leaderboard-47a977c54ff74fd48eac780a9d518c70", note: "Now serving as their in-house security expert" },
];
...
export const solo: SoloAudit[] = [
  ...
  { client: "Ambire-1", tags: ["account-abstraction"], links: [{ label: "Open", href: "https://gist.github.com/0xcuriousapple/3a670a8980991833df9ee124a6934e52" }] },
  { client: "Nostra-1", tags: ["lending"], links: [{ label: "Open", href: "https://gist.github.com/0xcuriousapple/3c306d93f884348c82b444c8ac2194ff" }] },
];
...
export const bountyFootnote =
  "* The payout wasn't offered in this case — they argued no funds were at risk due to low traction for these features. However, the features were publicly available, declared safe and audited, in production, and announced as a major release on their socials. There should have been at least a minimum critical payout, but with no official bug bounty program there was no other option.";
